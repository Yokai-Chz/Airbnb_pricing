...
Una aplicación de Machine Learning diseñada para estimar dinámicamente el precio óptimo por noche de propiedades de Airbnb en la Ciudad de México. 

Este proyecto implementa un Modelo de Precios, evaluando el valor de un inmueble basándose estrictamente en sus características intrínsecas (ubicación, capacidad, amenidades) para resolver el problema del "arranque en frío" en propiedades nuevas sin historial de reseñas.
